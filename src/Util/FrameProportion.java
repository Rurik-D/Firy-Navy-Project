...
public abstract class FrameProportion{
		...
		protected static int yesBtnX = (int)Math.round(Menu.WIDTH * 6.510 / 100);
		protected static int yesBtnY = (int)Math.round(Menu.HEIGHT * 61.342 / 100);
		protected static int yesBtnW = (int)Math.round(Menu.WIDTH * 7.812 / 100);
		protected static int noBtnX = (int)Math.round(Menu.WIDTH * 16.276 / 100);
		
		protected static int extLabelW = (int)Math.round(Menu.WIDTH * 29.296 / 100);
		protected static int extLabelX = (int)Math.round(Menu.HEIGHT * 2.893 / 100);
		protected static int extLabelY = (int)Math.round(Menu.HEIGHT * 55.555 / 100);
		
		protected static int fontDim = (int)Math.round((Menu.WIDTH + Menu.HEIGHT) * 1.458 / 100);
		...
		protected static int volumeBtnsY = (int)Math.round(Menu.HEIGHT * 71.412 / 100);
